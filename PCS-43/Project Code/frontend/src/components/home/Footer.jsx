...
const Footer = () => {
  return (
    <footer className="bg-[#171b1b] text-white lg:text-left">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start text-linkBlue">
              Products
            </h6>
            <p className="mb-4">
